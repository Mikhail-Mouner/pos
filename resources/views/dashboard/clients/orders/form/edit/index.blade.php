                                                                    ...
                                                                    <tr>
                                                                        ...
                                                                        <td>
                                                                            <a href=""
                                                                               ...
                                                                               class="btn @if(in_array($product->id,  $order->products->pluck('id')->toArray() )) btn-dark disabled @else btn-success @endif btn-sm add-product-btn">
                        ...
                        <div class="col-md-6">
                            ...
                            <div class="card card-primary">
                                ...
                                <div class="card-body">
                                    ...
                                    <form action="{{ route('dashboard.client.order.update', [$client->id, $order->id]) }}" method="post">
                                        ...
                                        <table class="table table-hover">
                                            ...
                                            @foreach($order->products as $product)
                                                @php $total += $product->sale_price * $product->pivot->qty @endphp
                                                <tr>
                                                    <td>{{ $product->name }}</td>
                                                    <td><input type="number" name="products[{{ $product->id }}][qty]" data-price="{{ $product->sale_price }}" class="form-control input-sm product-quantity" min="1" value="{{ $product->pivot->qty }}"></td>
                                                    <td class="product-price">{{ $product->sale_price * $product->pivot->qty }}</td>
                                                    <td><button class="btn btn-danger btn-sm remove-product-btn" data-id="{{ $product->id }}"><span class="fi fi-thrash"></span></button></td>
                                                </tr>
                                            @endforeach
                                            </tbody>
                                        ...
                                        <h4>{{ __('details.total') }} : <span class="total-price">{{ $total }}</span></h4>

                                        <button class="btn btn-primary btn-block " id="add-order-form-btn"><i class="fi fi-plus"></i> {{ __('action.add order') }}</button>
