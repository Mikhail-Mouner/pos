                ...
                <header class="d-flex b-0">
                    ...
                    <h2 class="h5 text-truncate w-100">
                        ...
                        @if(auth()->user()->hasPermission('products_create'))
                            <a href="{{ route('dashboard.product.create') }}" class="btn-link">
                            ...
                            <tr>
                                ...
                                <td>
                                    @if(auth()->user()->hasPermission('products_update'))
                                        <a class="btn btn-success btn-sm" href="{{ route('dashboard.product.edit',$product->id) }}"><i class="fi fi-pencil"></i> {{ __('action.edit') }}</a>
                                    @endif
